...
-- Manipular os dados dentro das tabelas criadas - inserir, atualizar e deletar registros
...
-- Inserindo dados em ações
INSERT INTO acoes (simbolo, nome_empresa, preco_atual) VALUES ('AAPL', 'Apple Inc.', 150.00);
INSERT INTO acoes (simbolo, nome_empresa, preco_atual) VALUES ('GOOGL', 'Alphabet Inc.', 2000.00);

-- Inserindo dados em transações
INSERT INTO transacoes (investidor_id, acao_id, tipo_transacao, quantidade, preco) VALUES (1, 2, 'COMPRA', 10, 145.00);
...
--Deletando uma transação (exemplo)
